...
def create_streak_scenario(selected_name, metrics_df):
    ...
    if st.session_state.challenge_end_date:
        ...
        days_left = 90  # Default to full challenge length if no end date set
...
def display_milestone_hall_of_fame():
    if st.session_state.milestones:
        ...
        # Calculate who can still get the perfect 90-day milestone
        today = date.today()
        if st.session_state.challenge_start_date and st.session_state.challenge_end_date:
            ...
            if days_elapsed < days_total:
                ...
                <div class='info-box'>
                    ...
                    <p class='dark-text'><strong>Perfect Streak Potential:</strong> {perfect_streak_possible} boggers still have a chance to achieve the perfect 90-day streak!</p>
                </div>
                """, unsafe_allow_html=True)
            else:
                # Challenge is over
                ...
                <div class='info-box'>
                    <p class='dark-text'><strong>Milestone Summary:</strong> {milestone_summary}</p>
                    <p class='dark-text'><strong>Challenge Complete!</strong> {perfect_streak_possible} boggers achieved the perfect 90-day streak!</p>
                </div>
                """, unsafe_allow_html=True)
    ...
    with st.container():
        ...
        if st.session_state.challenge_start_date:
            ...
            with col2:
                ...
                st.markdown(f"<p class='dark-text'><strong>Total Days:</strong> 90</p>", unsafe_allow_html=True)
...
if st.session_state.data is not None and st.session_state.view_start_date is not None:
    ...
    with tabs[0]:  # Leaderboards tab
        ...
        st.markdown("""
        <div class='milestone-notification'>
            <h3>🏆 Ultimate Challenge Goal: 90-Day Streak! 🏆</h3>
